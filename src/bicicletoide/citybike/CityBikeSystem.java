...
public class CityBikeSystem {
	...
	/**
	 * Crea una instancia del sistema de gesti√≥n de bicicletas de la ciudad. Por defecto, no lleva asignado ning√∫n punto.
	 */
	 ...
	 * tarjeta monedero, genera una excepciÛn en caso de que no haya saldo suficiente,
	 * Si no hay bicis en el punto de aparcamiento se devuelve el dinero.
	 * 
	 * Lanza una excepciÛn en caso de que alguno de los argumentos sea null
	 * @param p
	 * @param t
	...
	/**
	 * AÔøΩade un punto al sistema. El punto no tiene que haber sido introducido en el sistema con anterioridad
	 * 
	 * @param point
	 */
	...
	/**
	 * Elimina un punto del sistema. Se permite (y se recomienda) pasar una copia del punto en cuesti√≥n. El punto debe estar en el sistema
	 * @param point
	 */
	...
	public void setFianza(double fianza){
		if (fianza<0){
			throw new IllegalArgumentException("La fianza debe ser un n√∫mero positivo");
		}
		this.fianza = fianza;
	}
