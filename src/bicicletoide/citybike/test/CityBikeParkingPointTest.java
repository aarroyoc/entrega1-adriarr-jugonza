...
public class CityBikeParkingPointTest {
	...
	public void testConstructorAnclajesNegativos(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(-1,2,5,5);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testConstructorAnclajesMenorQueOcupados(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(2,3,5,5);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testConstructorCoordenadasMal(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(3,2,110,0);
	}
	
	@Test(expected=IllegalStateException.class)
	public void testPrestarBiciVacio(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(5,0,5,5);
		point.prestarBici();
	}
	
	@Test(expected=IllegalStateException.class)
	public void testDevolverBiciLleno(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(5,5,5,5);
		point.devolverBici();
	}
	...
	public void testDevolverBici(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(5,4,5,5);
		point.devolverBici();
	...
	public void testGetDistanciaGPSNull(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(3,2,50,0);
		GPS g = null;
	...
	public void testGetDistanciaPuntoBien(){
		CityBikeParkingPoint point = new CityBikeParkingPoint(3,2,50,0);
		CityBikeParkingPoint p = new CityBikeParkingPoint(3,2,70,0);
	...
	public void testEqualsBien(){
		CityBikeParkingPoint point1 = new CityBikeParkingPoint(3,2,50,0);
		CityBikeParkingPoint point2 = new CityBikeParkingPoint(3,2,50,0);
