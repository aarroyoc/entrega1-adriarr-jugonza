...
public class CityBikeSystemTest {
	...
	public void add() {
		...
		CityBikeParkingPoint point = new CityBikeParkingPoint(0,0,0,0);
	...
	public void getAll(){
		CityBikeSystem cbs = new CityBikeSystem();
		CityBikeParkingPoint point1 = new CityBikeParkingPoint(0,0,0,0);
		CityBikeParkingPoint point2 = new CityBikeParkingPoint(0,0,1,0);
		CityBikeParkingPoint point3 = new CityBikeParkingPoint(0,0,1,1);
